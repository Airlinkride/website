        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-400">
                Yes. AirLink Ride operates 24 hours a day, 7 days a week to
                accommodate early morning departures and late-night arrivals.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                Yes. We recommend booking your airport limo in advance to ensure
                availability and smooth pickup scheduling.
              </p>
            </motion.div>
          </div>
        </div>
